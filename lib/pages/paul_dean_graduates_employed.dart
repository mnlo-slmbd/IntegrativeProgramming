...
class PaulDeanGraduatesEmployed extends StatelessWidget {
  @override
                ...
                children: [
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          margin: EdgeInsets.fromLTRB(22, 0, 22, 62),
                          child: Align(
                        ...
                        Container(
                          margin: EdgeInsets.fromLTRB(30, 0, 30, 51),
                          child: Align(
                            alignment: Alignment.topLeft,
                            child: ClipRect(
                        ...
                        Container(
                          ...
                          child: Container(
                            padding: EdgeInsets.fromLTRB(34, 41.5, 29, 848),
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.start,
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                Container(
                                  margin: EdgeInsets.fromLTRB(0, 0, 1, 37.5),
                                  child: Text(
                                    'Departments',
                                    style: GoogleFonts.getFont(
                                      'Montserrat',
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                                padding: EdgeInsets.fromLTRB(0, 0, 0, 10.5),
                                                child: Column(
                                      ...
                                      Container(
                                              padding: EdgeInsets.fromLTRB(15.1, 25, 15.1, 15.5),
                                              child: Column(
                                                mainAxisAlignment: MainAxisAlignment.start,
                                                crossAxisAlignment: CrossAxisAlignment.center,
                                                children: [
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                                padding: EdgeInsets.fromLTRB(14.4, 25, 15.4, 19.5),
                                                child: Column(
                                                  mainAxisAlignment: MainAxisAlignment.start,
                                                  crossAxisAlignment: CrossAxisAlignment.center,
                                                  children: [
                                      ...
                                      Container(
                                              padding: EdgeInsets.fromLTRB(18.8, 29, 19.8, 19.5),
                                              child: Column(
                                                mainAxisAlignment: MainAxisAlignment.start,
                                                crossAxisAlignment: CrossAxisAlignment.center,
                                                children: [
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                                padding: EdgeInsets.fromLTRB(0, 37, 2, 25),
                                                child: Stack(
                                                  clipBehavior: Clip.none,
                                                  children: [
                                                    Column(
                                      ...
                                      Container(
                                              padding: EdgeInsets.fromLTRB(10.5, 33, 10.5, 25),
                                              child: Stack(
                                                clipBehavior: Clip.none,
                                                children: [
                                                  SizedBox(
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                                padding: EdgeInsets.fromLTRB(15.9, 35, 16.9, 15.5),
                                                child: Stack(
                                                  clipBehavior: Clip.none,
                                                  children: [
                                                    SizedBox(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Container(
                                                            margin: EdgeInsets.fromLTRB(13.1, 0, 18.1, 10.5),
                                                            child: Container(
                                                              decoration: BoxDecoration(
                                                                color: Color(0xFFFFFFFF),
                                                                borderRadius: BorderRadius.circular(48),
